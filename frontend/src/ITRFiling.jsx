        ...
        <>
          ...
          <div style={S.card}>
            ...
            {Object.entries(ITR_FORMS).map(([key, f]) => (
              <div key={key} style={{ display: 'flex', gap: 12, padding: '10px 0', borderBottom: '1px solid var(--border)', alignItems: 'center', flexWrap: 'wrap' }}>
                <div style={{ width: 95, flexShrink: 0 }}>
                  <span style={S.badge(f.color)}>{key}</span>
                </div>
